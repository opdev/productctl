...
func Command() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "operators /path/to/product-declaration.yaml /path/to/generated-mappings.yaml",
		Short: "Run Operator Certification for a given Product Listing",
	...
	flags.String(cli.FlagIDRuntimeImage, libcerttoolrunner.DefaultImageCertifyOperators, "The container image to use to certify Operator bundles")
